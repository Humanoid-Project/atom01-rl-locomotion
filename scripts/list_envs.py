...
All the environments are registered in the `robonex_train` extension. They start
...
import robonex_train.tasks  # noqa: F401


def main():
    """Print all environments registered in `robonex_train` extension."""
